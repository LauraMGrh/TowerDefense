                PANGOLIN INVASION GAME - By Rémi DAGORN & Laura MASSON-GREHAIGNE (Tp6 binome 5)
...
2. LES COMMANDES DE JEU:
-S : pour commencer le jeu.
-P : pour faire pause.
-C : seulement quand vous etre en pause ou Ã  l'écran de démarrage, pour revoir les commandes.
...
4. NOTRE REPARTITION DU TRAVAIL :
Nous avons globalement toujours travailler en même temps, sur visual studio code avec un live share afin de travailler sur la même base.
La majorité du fichier Display, ainsi que les images et graphismes ont été fait par Rémi.
Laura a codé tout ce qui est en rapport avec les tours (pose des tours, évolutions, missiles, attaques des tours...etc )
A part cela, la majorité du projet a été codé et réfléchi en équipe.